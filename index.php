...
<section id="slider" class="flexslider-wrap fullscreen clearfix">
    <div class="slider-wrapper">
        <div class="flexslider clearfix">
            <ul class="slides">
                <li class="clearfix" style="background-image: url(image/dua.jpg); background-size: cover; background-repeat: no-repeat;">
                    <div class="overlay color"></div>
                    <div class="flex-content vertical-center">
                        <div class="container">

                            <div class="caption wow fadeInUp">
                                <h1 style="color: #ffffff; font-size: 46px;">Selamat Datang DI<br>SD N 3 Kalikarung</h1>
                            </div>

                            <div class="caption wow fadeInUp">
                                <div class="button-normal white">
                                    <a href="https://wa.me/+6285328918334">Daftar Sekarang</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <li class="clearfix" style="background-image: url(image/Guru1.jpg); background-size: cover; background-repeat: no-repeat;">
                    <div class="overlay color"></div>
                    <div class="flex-content vertical-center">
                        <div class="container">
                            ...
                            <div class="caption wow fadeInUp">
                                <div class="button-normal white">
                                    <a href="http://localhost/profile/info.php">Info Daftar</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6 wow fadeIn">
                    ...
                    while ($b = mysqli_fetch_assoc($sql)) {
                        ...
                        ?>
                        <p>"Membangun Generasi Cerdas dan Berkarakter"</p>
                        <p>Profil SD N 3 Kalikarung</p>
                    <?php } ?><div class="button-normal green">
                        <a href="http://localhost/profile/info.php">Selengkapnya</a>
                    </div>
                </div>

                <div class="about-img col-md-6 wow fadeInLeft">
                    <img src="image/empat.png" alt="" />
                </div>
            </div>
        </div>
    </div>
